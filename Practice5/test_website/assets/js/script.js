    ...
    buildSlider: function() {
        ...
        for(let slide of this.slides) {
           ...
           <a class='link' href='${slide.link}' target='_blank'>Open</a></div></div>`;
            ...
            btn.innerHTML = "Slide " + (good_index + 1);

            var myDiv = document.getElementById("314");
            ...
            btn.addEventListener("click", ()=> {
                    ...
                    console.log("start");
                    let something = slide.id.slice(-1);
                    console.log(indexx + "|" + something)
                    console.log(typeof (indexx) + typeof (something))

                    while (indexx != something) {
                        this.nextSlide();
                    }
                }
            );
